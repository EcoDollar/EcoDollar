...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/ecodollar-cli.cpp \
           src/ecodollar-tx.cpp \
           src/ecodollar.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/ecodollar.qrc src/qt/ecodollar_locale.qrc

TRANSLATIONS += src/qt/locale/ecodollar_bg.ts \
                src/qt/locale/ecodollar_de.ts \
                src/qt/locale/ecodollar_en.ts \
                src/qt/locale/ecodollar_es.ts \
                src/qt/locale/ecodollar_fi.ts \
                src/qt/locale/ecodollar_fr.ts \
                src/qt/locale/ecodollar_it.ts \
                src/qt/locale/ecodollar_ja.ts \
                src/qt/locale/ecodollar_pl.ts \
                src/qt/locale/ecodollar_pt.ts \
                src/qt/locale/ecodollar_ru.ts \
                src/qt/locale/ecodollar_sk.ts \
                src/qt/locale/ecodollar_sv.ts \
                src/qt/locale/ecodollar_vi.ts \
                src/qt/locale/ecodollar_zh_CN.ts \
                src/qt/locale/ecodollar_zh_TW.ts
