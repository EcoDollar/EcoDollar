...
The build script we'll be using is contained in the ECODOLLAR github repository ([contrib/gitian-build.py](https://github.com/ecodollar/ecodollar/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the ECODOLLAR repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/ECODOLLAR-Project/ECODOLLAR/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, ecodollar-detached-sigs, and ecodollar GitHub repos.
