...
The script [extract-osx-sdk.sh](https://github.com/ecodollar/ecodollar/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
ecodollar/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/ecodollar/ecodollar/blob/master/doc/README_osx.md) for troubleshooting tips.