...
/** Utility functions used by the ECODOLLAR Qt UI.
 */
namespace GUIUtil
{
...
// Render ECODOLLAR addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZecos = false);
...
// Parse "ecodollar:" URI into recipient object, return true on successful parsing
