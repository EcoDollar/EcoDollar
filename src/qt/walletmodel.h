...
#ifndef ECODOLLAR_QT_WALLETMODEL_H
#define ECODOLLAR_QT_WALLETMODEL_H
...
/** Interface to ECODOLLAR wallet from Qt view code. */
...
#endif // ECODOLLAR_QT_WALLETMODEL_H
