...
#include "qt/ecodollar/contactsdropdown.h"
#include "qt/ecodollar/sendmultirow.h"
#include "qt/ecodollar/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(ECODOLLARGUI* parent);
    ~SendWidget();
...
private slots:
    void onECOSSelected(bool _isECOS);
    void onSendClicked();
...
private:
    ...
    bool sendZecos(QList<SendCoinsRecipient> recipients);
