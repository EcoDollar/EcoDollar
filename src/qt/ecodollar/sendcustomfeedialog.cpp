...
#include "qt/ecodollar/forms/ui_sendcustomfeedialog.h"
    ...
    ui(new Ui::SendCustomFeeDialog)
{
    ...
    ui->labelMessage->setText(tr("Customize the transaction fee, depending on the fee value your transaction will be processed faster on the blockchain."));
    ...
    ui->lineEditCustomFee->setPlaceholderText("0.000001 ECOS");
