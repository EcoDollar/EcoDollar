...
#ifndef ECODOLLAR_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define ECODOLLAR_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //ECODOLLAR_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
