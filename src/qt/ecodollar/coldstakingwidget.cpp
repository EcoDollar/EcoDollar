...
#include "qt/ecodollar/coldstakingwidget.h"
#include "qt/ecodollar/forms/ui_coldstakingwidget.h"
#include "qt/ecodollar/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/ecodollar/requestdialog.h"
#include "qt/ecodollar/tooltipmenu.h"
#include "qt/ecodollar/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(ECODOLLARGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your ECOSs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept ECOS delegation / Delegate ECOS"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select ECOS outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 ECOS" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
