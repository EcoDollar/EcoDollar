...
#include "qt/ecodollar/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/ecodollar/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(ECODOLLARGUI* _window, QWidget *parent) :
