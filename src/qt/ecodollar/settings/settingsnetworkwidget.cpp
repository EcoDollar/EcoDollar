...
#include "qt/ecodollar/settings/settingsnetworkwidget.h"
#include "qt/ecodollar/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/ecodollar/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(ECODOLLARGUI* _window, QWidget *parent) :
