...
#include "qt/ecodollar/settings/settingssignmessagewidgets.h"
#include "qt/ecodollar/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(ECODOLLARGUI* _window, QWidget *parent) :
