...
#include "qt/ecodollar/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ecodollar/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(ECODOLLARGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to ECODOLLARGUI::handleRestart()
