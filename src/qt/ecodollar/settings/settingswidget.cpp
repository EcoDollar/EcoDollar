...
#include "qt/ecodollar/settings/forms/ui_settingswidget.h"
#include "qt/ecodollar/settings/settingsbackupwallet.h"
#include "qt/ecodollar/settings/settingsbittoolwidget.h"
#include "qt/ecodollar/settings/settingswalletrepairwidget.h"
#include "qt/ecodollar/settings/settingswalletoptionswidget.h"
#include "qt/ecodollar/settings/settingsmainoptionswidget.h"
#include "qt/ecodollar/settings/settingsdisplayoptionswidget.h"
#include "qt/ecodollar/settings/settingsmultisendwidget.h"
#include "qt/ecodollar/settings/settingsinformationwidget.h"
#include "qt/ecodollar/settings/settingsconsolewidget.h"
...
SettingsWidget::SettingsWidget(ECODOLLARGUI* parent) :
    PWidget(parent),
