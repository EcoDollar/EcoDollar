...
#include "qt/ecodollar/forms/ui_receivewidget.h"
...
#include "qt/ecodollar/addressholder.h"
...
ReceiveWidget::ReceiveWidget(ECODOLLARGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive ECOS."));
