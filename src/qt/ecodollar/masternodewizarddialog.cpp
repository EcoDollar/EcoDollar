...
#include "qt/ecodollar/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 39123");
    ...
    if(walletModel->isTestNetwork()){
        ...
        ui->lineEditPort->setText("39125");
    } else {
        ui->lineEditPort->setText("39123");
    }
