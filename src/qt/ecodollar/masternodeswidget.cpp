...
#include "qt/ecodollar/forms/ui_masternodeswidget.h"
#include "qt/ecodollar/qtutils.h"
#include "qt/ecodollar/mnrow.h"
#include "qt/ecodollar/mninfodialog.h"

#include "qt/ecodollar/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(ECODOLLARGUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:39023 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
