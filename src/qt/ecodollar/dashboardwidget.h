...
#include "config/ecodollar-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalEcos = 0;
    qint64 totalZecos = 0;
    QList<qreal> valuesEcos;
    QList<qreal> valueszEcos;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(ECODOLLARGUI* _window);
    ~DashboardWidget();
