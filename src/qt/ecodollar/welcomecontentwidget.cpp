...
#include "qt/ecodollar/forms/ui_welcomecontentwidget.h"
#include <QFile>
#include <QListView>
#include <QDir>
#include "guiutil.h"
...
void WelcomeContentWidget::initLanguages(){
    ...
    //i->comboBoxLanguage->addItem("English (en)", "en_US");
    //ui->comboBoxLanguage->addItem("Español - España (es_ES)", "es_ES");
    //ui->comboBoxLanguage->addItem("Español (es)", "es");
