...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, ECODOLLARGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, ECODOLLARGUI *gui, double posX = 3);
