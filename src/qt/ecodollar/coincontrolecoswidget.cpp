...
#include "qt/ecodollar/coincontrolecoswidget.h"
#include "qt/ecodollar/forms/ui_coincontrolecoswidget.h"

CoinControlEcosWidget::CoinControlEcosWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlEcosWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select ECOS Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("ECOS");
    ...
    ui->labelValueAfter->setText("0.00 ECOS");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 ECOS");
    ui->labelValueFee->setText("0.00 ECOS");
...
CoinControlEcosWidget::~CoinControlEcosWidget()
{
    delete ui;
}
