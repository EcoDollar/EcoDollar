...
/* Ecodollar GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ECODOLLAR"
#define QAPP_ORG_DOMAIN "ecodollar.org"
#define QAPP_APP_NAME_DEFAULT "ECODOLLAR-Qt"
#define QAPP_APP_NAME_TESTNET "ECODOLLAR-Qt-testnet"
