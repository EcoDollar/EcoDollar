...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ecodollar Core ecodollar-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ecodollar-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ecodollar transaction") + "\n" +
                               "  ecodollar-tx [options] -create [commands]   " + _("Create hex-encoded ecodollar transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ecodollar transaction
