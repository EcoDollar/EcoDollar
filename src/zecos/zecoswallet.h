...
#ifndef ECODOLLAR_ZECOSWALLET_H
#define ECODOLLAR_ZECOSWALLET_H
...
public:
    CzECOSWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZECOS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZECOS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
