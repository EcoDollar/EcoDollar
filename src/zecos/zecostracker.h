...
#ifndef ECODOLLAR_ZECOSTRACKER_H
#define ECODOLLAR_ZECOSTRACKER_H
...
public:
    CzECOSTracker(std::string strWalletFile);
    ~CzECOSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzECOSWallet* zECOSWallet = NULL);
...
#endif //ECODOLLAR_ZECOSTRACKER_H
