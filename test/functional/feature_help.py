...
"""Verify that starting ecodollar with -h works as expected."""
import subprocess

from test_framework.test_framework import EcodollarTestFramework
from test_framework.util import assert_equal

class HelpTest(EcodollarTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ecodollar with -h for help text")
        ...
        self.log.info("Start ecodollar with -version for version information")
